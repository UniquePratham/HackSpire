...
import {
  ...
  export default function Contact() {
    ...
    const cardBorder = useColorModeValue("rgba(255, 255, 255, 0.3)", "rgba(0, 0, 0, 0.3)");
          ...
          >
            ...
            <Flex justify="space-between" align="center" flexWrap="wrap" gap={4}>
              <MotionBox
                ...
                boxShadow="md"
              >
                <Box mb={4} color="cyan.500" display="flex" justifyContent="center">
                  <FaPhoneAlt size="50" />
                </Box>
              ...
              <MotionBox
                ...
                boxShadow="md"
              >
                <Box mb={4} color="red.400" display="flex" justifyContent="center">
                  <FaFileAlt size="50" />
                </Box>
                <Text fontSize="lg" mb={4}>
              ...
              <MotionBox
                ...
                boxShadow="md"
              >
                <Box mb={4} color="orange.400" display="flex" justifyContent="center">
                  <FaComments size="50" />
                </Box>
                <Text fontSize="lg" mb={4}>
